...
// package zmq.util;
 * 
 * This file has been originally copied from 
 * https://github.com/zeromq/jeromq/blob/master/src/main/java/zmq/util/Z85.java 
 * 
 */
...
public class Z85
{
	public static void main(String[] args) {
		...
		int siz4 = size + (4 - size%4);
		System.out.println("text: " + text);
		System.out.println("size: " + size);
		System.out.println("siz4: " + siz4);
		String enc = encode(text.getBytes(), siz4);
		System.out.println(" z85: " + enc );
		String dec = new String(decode(enc));
		System.out.println("back: " + dec );
	}
     ...
     * size * 5 / 4 bytes long plus 1 byte for the null terminator. 
     * Returns dest. Size must be a multiple of 4.
